...
This is the guide I loosely followed to setup *motion* on my Raspberry PI 
http://www.instructables.com/id/Raspberry-Pi-as-low-cost-HD-surveillance-camera/step6/Put-the-hardware-together/

And in case anyone if interested (or lazy) about the content of my `motion.conf` File here it is, I don't quite recall all the changes besides adding the path to the commands that need to be executed depending on the event but it shouldn't be that hard to do a diff between this and your default file.
...
on_picture_save /opt/picam_s3_and_prowl/index.js %f
...
# To give the filename as an argument to a command append it with %f
on_movie_end /opt/picam_s3_and_prowl/index.js %f 
...
### Bluetooth
For the Bluetooth part of my code to work (detect "if I'm home" A.K.A phone proximity before sending notifications) you can loosely follow the selected answer here: http://raspberrypi.stackexchange.com/questions/15454/detect-if-iphone-android-nearby

**Note:** For iOS there's a bit more trickery that needs to be done in order to paint the phone with your PI, drop me a line if you can't figure it out and I will gladly update this with the instructions.
